    ...
    tabItems(
      ...
      tabItem(tabName = "i", 
              column(width = 6, 
                     ...
                     checkboxInput("trackman", "Is Trackman Data?", FALSE),
...
server <- function(input, output, session) {
  ...
  values <- reactiveValues(table1 = NULL,
                           ...
                           df = NULL,
                           markov = NULL,
                           markov_title = input$markov_title,
                           markov_subtitle = input$markov_subtitle,
                           markov_caption = input$markov_caption,
                           markov_outfile = input$markov_outfile)
