      ...
      tabItem(tabName = "f", 
              ...
              tabsetPanel(
                tabPanel("Select Filter Variables",
                      ...
                      h3("Pitcher Name"),
                      selectInput("pitcher_name_filter_var", "Select Pitcher (if applicable)", 
...
server <- function(input, output, session) {
  ...
  data <- reactive({
    ...
    updateSelectInput(session, "pitcher_name_filter_var", choices = names(df)) 
  ...
  output$pn_filter <- renderUI({
    ...
    pitchers <- unique(values$df[,colnames(values$df) == input$c_swm_filter_var])
    checkboxGroupInput("pn_filter", "Select Pitcher(s): ", choices = pitchers)
  })
